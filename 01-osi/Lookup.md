...
Conduct online research in order to answer specific technical questions involving the Domain Name System (DNS) protocol.
...
![alt text](/01-osi/image/image.png)
...
2. What type of DNS record is used to map hostnames to IPv6 addresses?
    AAAA Record type holds IPv6 addresses. Information - [RFC 3596](https://www.rfc-editor.org/rfc/rfc3596)

3. What type of DNS record is used to delegate a DNS zone?
    NS (Name Server) delegates a DNS zone. Information - [RFC 1035](https://tools.ietf.org/html/rfc1035#page-12)